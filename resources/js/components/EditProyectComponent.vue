<template>
  <v-container class="">
    <!--Barra Botones-->
    <v-row>
      <v-toolbar color="primary" class="white--text pt-0 pb-0 text-h5">
        ...
        <v-col class="text-right" elavation="0">
          <v-responsive>
            <!--Agregar miembro-->
            <v-tooltip top>
              <template v-slot:activator="{ on }">
              ...
              <template v-slot:activator="{ on }">
                ...
                >
                  ...
                  <v-dialog v-model="dialogAlert" color="red" max-width="40%">
                    <v-card color="">
                      <v-card-title class="text-h6 text-c"
                        >Seguro que desea borrar el proyecto?</v-card-title
                      >
                      <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn
                        ...
                        <v-btn
                          color="red"
                          class="btn-danger white--text"
                          @click="deleteProject(proyectData.id)"
                          >Confirmar</v-btn
                        >
                        <v-spacer></v-spacer>
                      </v-card-actions>
    ...
    <v-row>
      <v-col>
        <info-project-component :projectUp="projectUp">
  ...
  data() {
    return {
      fields: [
        ...
        { name: "Scrum Masters", selected: this.leads, fullList: this.users },
        { name: "Desarrolladores", selected: this.devs, fullList: this.users },
      ],
      projects: [],
      projectUp: {
