      ...
      >
        ...
        <v-list>
            <v-list-item class="px-2">
                ...
                <v-list-item-title class="text-h6 white--text d.flex pl-6 mr-6">
                    Usuario
                </v-list-item-title>
            </v-list-item>
        </v-list>
        ...
        <v-list
          ...
          rounded
        >
            <!-- CAMBIANDO COD. PARA NAVEGAR (evaluando para el proximo sprint) -->
            <!--<v-list-item-group
  ...
  export default {
    data: () => ({
      ...
      items: [
        ...
        { text: 'Proyectos', icon: 'mdi-folder-multiple' },
