...
Vue.component('sprint-container',
              require('./components/SprintContainer.vue').default);

import App from "./components/App.vue";
const app = new Vue(
    {el : '#app', components : {App, example, tasklist, Card, Board}, vuetify});
